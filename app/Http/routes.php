...
//     Route::get('admin/products',['as'=> 'admin.products', 'uses' => 'ProductController@index']);
...
//     Route::get('admin/products/edit',['as'=> 'admin.products.edit', 'uses' => 'ProductController@edit']);
//     Route::put('admin/products/update',['as'=> 'admin.products.update', 'uses' => 'ProductController@update']);
