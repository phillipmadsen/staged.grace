...
return [
    ...
    */
    ...
    'namespace' => [
        ...
        'datatables'        => 'Fully\DataTables',

        'repository'        => 'Fully\Repositories',

        'controller'        => 'Fully\Http\Controllers',

        'api_controller'    => 'Fully\Http\Controllers\API',

        'request'           => 'Fully\Http\Requests',

        'api_request'       => 'Fully\Http\Requests\API',
    ],
