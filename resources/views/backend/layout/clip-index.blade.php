...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{!! asset('/clip/assets/plugins/select2/select2.css') !!}" />
        <link rel="stylesheet" href="{!! asset('/clip/assets/plugins/DataTables/media/css/DT_bootstrap.css') !!}" />
...
@if (Request::url(getLang() . '/admin'))
        <script src="{!! asset('/clip/assets/plugins/flot/jquery.flot.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/flot/jquery.flot.pie.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/flot/jquery.flot.resize.min.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/jquery.sparkline/jquery.sparkline.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/fullcalendar/fullcalendar/fullcalendar.js') !!}"></script>
        <script src="{!! asset('/clip/assets/js/index.js') !!}"></script>
@endif
        <script src="{!! asset('/clip/assets/plugins/ladda-bootstrap/dist/spin.min.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/ladda-bootstrap/dist/ladda.min.js') !!}"></script>
        <script src="{!! asset('/clip/assets/plugins/bootstrap-switch/static/js/bootstrap-switch.min.js') !!}"></script>
        <script src="{!! asset('/clip/assets/js/ui-buttons.js') !!}"></script>
