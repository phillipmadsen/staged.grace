        ...
        <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu menu-open" style="display: block;">
                    ...
                    <li class="treeview {{ setActive('admin/article*') }}">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            ...
                            <li> <a href="#"><i class="fa fa-plus-square"></i>Categories</a>
                    ...
                    <li class="treeview {{ setActive('admin/category*') }}"><a href="#"> <i class="fa fa-tag"></i> <span>Categories</span>
          ...
          {{--           <li class="treeview {{ setActive('admin/project*') }}"><a href="#"> <i class="fa fa-gears"></i> <span>Projects</span>
            ...
            <li class="treeview {{ setActive('admin/products*') }}"><a href="#"> <i class="fa fa-bookmark"></i> <span>eCommerce</span>
                    <i class="fa fa-angle-left pull-right"></i> </a>
                    <ul class="treeview-menu">
                        {{-- <li><a href="{{ action('Fully\Http\Controllers\Admin\ProductController@index') }}"><i class="fa fa-folder"></i> All Products</a> </li> --}}
