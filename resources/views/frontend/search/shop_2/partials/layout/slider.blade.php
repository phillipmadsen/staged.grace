		<section id="slider" class="slider-parallax revslider-wrap ohidden clearfix">
			...
			<div class="tp-banner-container">
				...
				<li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="10000" data-saveperformance="off" data-title="Latest Collections" style="background-color: #F6F6F6;">
					...
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style=""><img src="{!! asset('/frontend/images/slider/rev/shop/girl1.jpg') !!}" alt="Girl"></div>
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style=" color: #333;">Get your Quilting Frame Ready</div>
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style=" color: #333; max-width: 430px; line-height: 1.15;">Latest Technology <br>Collections</div>
				...
				<li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="10000"  data-saveperformance="off"  data-title="Messenger bags" style="background-color: #E9E8E3;">
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style=""><img src="{!! asset('/frontend/images/slider/rev/shop/bag.png') !!}" alt="Bag"></div>
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style=""><img src="{!! asset('/frontend/images/slider/rev/shop/tag.png') !!}" alt="Bag"></div>
