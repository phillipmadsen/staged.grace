                            ...
                            <tbody>
                                ...
                                <tr class="cart_item">
                                    <td class="cart-product-remove">
                                        <a href="/removeItem/{{$item->id}}" class="remove" title="Remove this item"><i class="icon-trash2"></i></a>
                                    </td>

                                    <td class="cart-product-thumbnail">
                                        {{-- <a href="#"><img width="64" height="64" src="{!! url('frontend/images/shop/thumbs/small/dress-3.jpg') !!}" alt="Pink Printed Dress"></a> --}}
