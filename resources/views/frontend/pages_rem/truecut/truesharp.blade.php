...
<section id="content">
   <div class="content-wrap" style="padding:0px;">
      ...
      <div class="container nobottommargin">
         ...
         <div class="col-sm-5">
            <img data-animate="fadeInRight" src="../images/product-overviews/truesharp/truesharp-main-open.jpg" / alt="TrueSharp 2 Electric Rotary Blade Sharpener">
         </div>
      </div>
      <!--video
      ===============================-->
      ...
      <div class="section nobottommargin" style="border-top:2px solid #B14949; border-bottom:2px solid #B14949;">
         <div class="container">
            ...
            <div class="col-sm-5">
               <img data-animate="fadeInRight" src="../images/product-overviews/truesharp/sharpener_in_use.jpg" />
            </div>
         </div>
      </div>
      <!-- Improvements
      =================================================== -->
      <div class="section parallax nomargin clearfix" style=" border-bottom:2px solid #B14949; background-image: url('../images/backgrounds/square_bg.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
      ...
      <div class="container">
         ...
         <div class="col-sm-5">
            <img src="../images/product-overviews/truesharp/diamond-stone.jpg" />
         </div>
      </div>
      <!--</div>-->
      <!-- any blade
      ...
      <div class="section parallax nomargin clearfix" style="border-top:2px solid #B14949; border-bottom:2px solid #B14949; background-image: url('/images/backgrounds/greyzz.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
         <div class="container center">
            ...
            <div class="row bottommargin">
               ...
               <div class="col-sm-8">
                  <img src="../images/product-overviews/truesharp/3_blades.png" alt="3 different size rotary blades">
               </div>
               <div class="col-sm-2"></div>
            </div>
         </div>
      ...
      <div class="container clearfix topmargin bottommargin">
         ...
         <div class="row clearfix">
            <div class="col_half  nobottommargin">
               <div class="feature-box center media-box fbox-bg">
                  <div class="fbox-media">
                     <img src="../images/product-overviews/truesharp/two-sides.png" alt="sharpens both side of rotary blade at the the same time">
                  </div>
                  <div class="fbox-desc">
            ...
            <div class="col_half col_last nobottommargin">
               <div class="feature-box center media-box fbox-bg">
                  <div class="fbox-media">
                     <img src="../images/product-overviews/truesharp/plug.png" alt="Plugs in. Sharpener doesn't use batteries">
                  </div>
                  <div class="fbox-desc">
                     <div class="heading-block nobottomborder nobottommargin">
      ...
      <div class="section parallax nomargin clearfix" style="border-top:2px solid #B14949; border-bottom:2px solid #B14949; background-image: url('../images/backgrounds/square_bg.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
         <div class="container bottommargin center">
            ...
            <img src="../images/product-overviews/truesharp/truesharp-kit.png" />
            <div class="row topmargin-sm center">
               <div class="col-md-3">
                  <img src="../images/product-overviews/truesharp/vector-stones.png" alt="high-quality sharpening stones" />
                  <h4 class="nobottommargin center">Sharpening Stones</h4>
                  <p style="font-style: italic;">One Set Fine &amp; One Set Coarse</p>
               </div>
               <div class="col-md-3">
                  <img src="../images/product-overviews/truesharp/vector-handler.png" alt="rotary blade handler">
                  <h4 class="nobottommargin">Rotary Blade Handlers</h4>
               </div>
               <div class="col-md-3">
                  <img src="../images/product-overviews/truesharp/vector-oil.png" alt="blade sharpening oil">
                  <h4 class="nobottommargin">Sharpening Oil</h4>
               </div>
               <div class="col-md-3">
                  <img src="../images/product-overviews/truesharp/vector-cleaning-cloth.png" alt="cleaning cloth">
      ...
      <div class="container topmargin-sm clearfix center">
         <div class="row">
            <div class="col-sm-6 bottommargin-lg">
               ...
               <img src="/images/product-overviews/linear_sharpener/truesharp_blades.png" alt="Linear Sharpener" />
               <div class="row">
                  <div>
                     <a href="/machine-quilting/gq-frame.html" class="button button-rounded button-small button-secondary">Learn More</a>
            ...
            <div class="col-sm-6 bottommargin-lg">
               ...
               <img src="/images/product-overviews/linear_sharpener/linear-blue.png" alt="Z44 Hand Quilting Frame King Size" />
               <div class="row">
                  <div>
                     <a href="/machine-quilting/gq-frame.html" class="button button-rounded button-small">Buy Now</a>
                  </div>
