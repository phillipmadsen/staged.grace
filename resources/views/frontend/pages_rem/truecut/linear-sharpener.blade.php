                 ...
                 <div class="container nobottommargin">
                        ...
                        <div class="row clearfix">
                          <div class="col-sm-2"></div>
                           ...
                           <div class="col-sm-8"><img data-animate="fadeInRight" src="../images/product-overviews/linear_sharpener/linear-sharpener-main.jpg" / alt="Linear Sharpener"></div>
               ...
               <div class="container clearfix topmargin bottommargin">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/linear_sharpener/stone.png" alt="sharpens both side of rotary blade at the the same time">
                                   </div>
                                   <div class="fbox-desc">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/linear_sharpener/safe.png" alt="Plugs in. Sharpener doesn't use batteries">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                        ...
                        <div class="row clearfix topmargin-sm">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/linear_sharpener/full_line.png" alt="sharpens both side of rotary blade at the the same time">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/linear_sharpener/sticky_feet.png" alt="Plugs in. Sharpener doesn't use batteries">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
