...
@section('title')
TrueCut Cutting Table | The Grace Company
@endsection
    ...
    =================================================== -->
                 ...
                 <div class="container nobottommargin">
                        ...
                        <div class="heading-block topmargin nobottommargin center">
                            ...
                            <img data-animate="fadeInRight" src="../images/product-overviews/cutting-table/table_big.png" alt="Cutting &amp; Crafting Table">
               ...
               <div class="container clearfix topmargin bottommargin">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/cutting-table/leaves_down.png" alt="Folding Table">
                                   </div>
                                   <div class="fbox-desc">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/cutting-table/storage.png" alt="Storage Shelves">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                        ...
                        <div class="row clearfix topmargin-sm">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/cutting-table/caster_wheels.png" alt="Caster Wheels">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/cutting-table/adj_legs.png" alt="Adjustable Legs">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                        ...
                        <div class="container bottommargin-sm" style="border-top:2px solid #b14949;">
                            <div class="heading-block center topmargin nobottomborder">
                                <h2>Size Specifications</h2>
                                    ...
                                    <img src="/images/product-overviews/cutting-table/table_plain.png" alt="Open Table" />
