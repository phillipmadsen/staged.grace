...
@section('content')
    ...
    =================================================== -->
                    ...
                    <div class="container bottommargin">
                        ...
                        <img src="../images/product-overviews/rulers/ruler_perspective.png" / alt="TrueCut roatary cutting ruler">
...
=======================================================-->
                 <div class="section parallax nomargin clearfix" style="border-top:2px solid #B14949; border-bottom:2px solid #B14949; background-image: url('/images/backgrounds/square_bg.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
                    <div class="container">
                            ...
                            <div class="col-sm-4">
                                <img data-animate="fadeInRight" src="../images/product-overviews/rulers/edge-close.png" />
                            </div>
                ...
                <div class="section parallax nomargin clearfix" style=" border-bottom:2px solid #B14949; background-image: url('/images/backgrounds/greyzz.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
                        ...
                        <div class="container">
                           <div class="heading-block topmargin nobottommargin center nobottomborder">
                                ...
                                <br>
                                <img src="../images/product-overviews/rulers/chip-resist.png">
                                <br>
                        ...
                        <img src="../images/product-overviews/rulers/ruler-bend.jpg" alt="Chip Resistant Rotary Cutting Ruler">
                        </div>
                    ...
                    <div class="heading-block center">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/rulers/1-2-inch.png" alt="extra rotary cutter blade exposure">
                                   </div>
                                   <div class="fbox-desc">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/rulers/incraments.png" alt="multiple rotary blade brands">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                       ...
                       <div class="row clearfix topmargin-sm">
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/rulers/left-right.png" alt="rotary cutter safety lock">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/rulers/angles.png" alt="Customizable Handle Inserts">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                        ...
                        <div class="container clearfix center">
                            ...
                            <div class="row" style="border-bottom: 1px solid #48A0C4;">
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-24half.png" alt="6.5 x 24.5 rotary cutting ruler" style="height: 300px;"/>
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-6x12half.png" alt="6.5 x 24.5 rotary cutting ruler" style="height: 300px;" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-3x18.png" alt="6.5 x 12.5 rotary cutting ruler" style="height: 300px;" />
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-square-12half.png" alt="12.5 x 12.5 rotary cutting ruler" style="height: 300px;"/>
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-square-9half.png" alt="9.5 x 9.5 rotary cutting ruler" style="height: 300px;" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm">
                                    ...
                                    <img src="../images/product-overviews/rulers/ruler-square-6half.png" alt="6.5 x 6.5 rotary cutting ruler" style="height: 300px;" />
                                <div class="row">
