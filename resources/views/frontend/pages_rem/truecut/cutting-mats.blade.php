...
@section('content')
    ...
    =================================================== -->
                ...
                <div class="col-xs-12 clearfix" style="padding: 0px;"><img src="../images/product-overviews/cutting-mats/mat-banner.png"></div>
                    ...
                    <div class="col-sm-8 center">
                        ...
                        <img src="../images/product-overviews/cutting-mats/truecut_mats.jpg" / alt="TrueCut cutting mats">
                   </div>
                ...
                <!---5-layer-pvc)
=======================================================-->
                 <div class="section parallax nomargin clearfix" style="border-top:2px solid #B14949; border-bottom:2px solid #B14949; background-image: url('/images/backgrounds/square_bg.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
                            ...
                            <div class="row">
                                ...
                                <h4 class="center">5-Layered Self-Healing Surfaces</h4>
                                    <p class="center" style="padding:0px; margin: 0px;"><img class="center" src="../images/product-overviews/cutting-mats/mats-layers.png" alt="5-layerd PVC cutting mat"></p>
                                ...
                                <div class="col-sm-6 col-last" style="padding-right: 0px;">
                                    <img data-animate="fadeInRight" src="../images/product-overviews/cutting-mats/sally_comfort.png" alt="truecut cutting mat in use" />
                                </div>
                            </div>
                     ...
                     <!-- Double Sided
    =================================================== -->
                <div class="section parallax nomargin clearfix" style=" border-bottom:2px solid #B14949; background-image: url('/images/backgrounds/greyzz.png'); padding:0px; background-repeat:repeat;" data-stellar-background-ratio="0.4">
                            ...
                            <div class="row">
                                ...
                                <p class="before-heading">Double the sides, double the use!</p>
                                    ...
                                    <div class="row center bottommargin-sm">
                                        <div class="col-xs-6"><img class="center" src="../images/product-overviews/cutting-mats/mat-side-1.png" alt="5-layerd PVC cutting mat"></div>
                                ...
                                <div class="col-sm-4 col-last" style="padding-right: 0px;">
                                    <img data-animate="fadeInRight" src="../images/product-overviews/cutting-mats/mat-fold.png" alt="double-sided cutting mat" />
                                </div>
                            </div>
                    ...
                    <div class="heading-block center">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/cutting-mats/numbers-outside.png" alt="easy to see grid measurements">
                                   </div>
                                   <div class="fbox-desc">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/cutting-mats/angles.png" alt="multiple rotary blade brands">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                       ...
                       <div class="row clearfix">
                           <div class="col_half  nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                     <img src="../images/product-overviews/cutting-mats/bias.png" alt="fabric bias lines">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                          ...
                          <div class="col_half col_last nobottommargin">
                               <div class="feature-box center media-box fbox-bg">
                                   <div class="fbox-media">
                                      <img src="../images/product-overviews/cutting-mats/right-left.png" alt="cutting mat read from both sides">
                                   </div>
                                   <div class="fbox-desc">
                                       <div class="heading-block nobottomborder nobottommargin">
                        ...
                        <div class="container topmargin-sm clearfix center">
                            ...
                            <div class="row">
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp">
                                    ...
                                    <img src="../images/product-overviews/cutting-mats/cutting-mat-36x24.png" alt="36x24 Cutting Mat" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp" data-delay="200">
                                    ...
                                    <img src="../images/product-overviews/cutting-mats/cutting-mat-24x18.png" alt="24x18 Cutting Mat" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp" data-delay="400">
                                    ...
                                    <img src="../images/product-overviews/cutting-mats/cutting-mat-18x12.png" alt="18x12 Cutting Mat" />
                                <div class="row">
...
====================================-->
                        ...
                        <div class="container topmargin-sm clearfix center">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src="../images/product-overviews/cutting-mats/mat-on-pad.png">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp">
                                    <h4 class="nobottommargin">36 x 24 Inches</h4>
                                    <img src="../images/product-overviews/cutting-mats/pad24x36.jpg" alt="Large Non-Slip Pad" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp" data-delay="200">
                                    <h4 class="nobottommargin">24 x 18 Inches</h4>
                                    <img src="../images/product-overviews/cutting-mats/pad-18x24.jpg" alt="Medium Non-Slip Pad" />
                                    <div class="row">
                                ...
                                <div class="col-sm-4 bottommargin-sm" data-animate="fadeInUp" data-delay="400">
                                    <h4 class="nobottommargin">18 x 12 Inches</h4>
                                    <img src="../images/product-overviews/cutting-mats/pad-12x18.jpg" alt="Small Non-Slip Pad" />
                                <div class="row">
