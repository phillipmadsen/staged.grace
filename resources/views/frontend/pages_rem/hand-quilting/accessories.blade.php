...
<section id="content">
   <div class="content-wrap" style="padding:0px;">
               ...
               <div class="col_half nobottommargin">
                  <div class="feature-box center media-box fbox-bg" data-animate="fadeInLeft">
                     <div class="fbox-media">
                        ...
                        <img  src="images/product-overviews/accessories/hard-shadow.jpg" alt="Without Balanced Light">
                     </div>
                     <div class="fbox-desc">
      ...
      <div class="row center bottommargin" style="border-top:2px solid #b14949; padding:20px;">
         ...
         <a href="shop/somewhere" class="button button-large button-rounded">See All Hand Quilting Accessories</a>
      </div>
   </div>
   <!--.content-wrap end-->
</section>
