      ...
      <div class="section parallax nobottommargin" style="background-image: url('{!! asset('/frontend/images/product-overviews/sr-2-frame/SR2-frame-RGBweb100ppi-angled.jpg') !!}');" data-stellar-background-ratio="0.4">
         <div class="container">
            <div data-animate="fadeInUp" class=" col-sm-4 fright  transparent-block-light" >
               ...
               <h3 class="nobottommargin topmargin-sm" itemprop="hasPart about" >Smooth Professional Carriage</h3>
               <span class="before-heading">For enhanced stitching</span>
               <p itemprop="description"> The smooth gliding professional series carriage provides ease of motion which aides in improved stich quality.</p>
            </div>
         </div>
      </div>
         ...
         <div class="row clearfix topmargin">
            ...
            <div class="col-lg-4">
               <div class="heading-block center">
                  <h3 itemprop="hasPart about" >Included Quilt Clips</h3>
            ...
            <div class="row topmargin-sm clearfix">
               <div class="col-md-6">
                  <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                     ...
                     <h4 itemprop="hasPart about" >Sewing Machine Base Clamps</h4>
                  </div>
                  <p itemprop="description">If your machine moves while sewing, it could ruin much more than your time &amp; patience. We&#39;ve eliminated any concerns you may have because included are base clamps to keep your sewing machine in place and keep you working.</p>
               </div>
               <div class="col-md-6">
                  <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                     <img src="{!! asset('/frontend/images/product-overviews/sr-2-frame/sr2-table-insert-on-frame.png') !!}" alt="SR2 Frame">
                     <h4 itemprop="hasPart about" >Sturdy Steel Construction</h4>
                  </div>
                  <p itemprop="description">Much of the body of the SR2 frame is constructed of steel giving you long lasting durability. The rails of the frame are also made from steel for maximum rigidity.</p>
               </div>
            </div>
            <div class="row topmargin-sm clearfix">
               <div class="col-md-6 ">
